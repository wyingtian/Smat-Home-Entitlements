...
import cscie97.asn4.housemate.controller.command.light.HouseLightsOnCommand;
...
public class SmokeDetectorCommand implements Command {
    ...
    public void execute() {
        ...
        Command com1 = new HouseLightsOnCommand(model,houseName,null);
        com1.execute();
        Command com2 = new RoomDoorOpenCommand((model.findApplianceByType(location,"door",null)));
        com2.execute();
        allAvaInHouseSpeak(houseName, FireBroadCastMessage, null);
     ...
     * @param authToken
     */
    public void allAvaInHouseSpeak(String houseName,String broadCastMessage,AccessToken authToken){
